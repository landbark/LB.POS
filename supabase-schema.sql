...
-- ================================================================
-- เว็บสาธารณะ + ร้านค้าออนไลน์ (ประกาศข่าว / ช่องทางติดต่อ / น้ำหนักสินค้า /
-- โซนค่าส่ง / ที่อยู่ลูกค้า / ออเดอร์) อยู่ใน supabase-migration-shop.sql
-- ติดตั้งใหม่: รันไฟล์นี้ก่อน แล้วรัน migration นั้นตามหลัง
-- ================================================================
